...
class book6cont : AppCompatActivity() {

    private lateinit var pdfView: PDFView

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_book6cont)

        pdfView = findViewById(R.id.pdfView)

        val assetFileName = "boo6.pdf" // Change this to your PDF file in the assets folder
