...
class book7cont : AppCompatActivity() {

    private lateinit var pdfView: PDFView

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_book7cont)

        pdfView = findViewById(R.id.pdfView)

        val assetFileName = "boo7.pdf" // Change this to your PDF file in the assets folder
